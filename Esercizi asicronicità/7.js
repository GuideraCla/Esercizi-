...
// filterArray dovrebbe restituire un nuovo array contenente solo gli elementi per i quali la funzione di 
// callback restituisce true.

function filterArray(arr, callback) {
   const numPari = arr.filter ( callback )
   return numPari
} 
