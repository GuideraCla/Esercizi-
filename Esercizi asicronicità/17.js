...
// il tipo di lavoro trovato. N.B: la stampa dei risultati deve avvenire solo nel momento in cui 
// entrambe le Promise sono state risolte.
...
const persons = [
  ...
  // Utilizzo Promise.all per ottenere entrambi i risultati
